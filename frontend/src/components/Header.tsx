    ...
    <header className="fixed top-0 left-0 right-0 z-50 h-16 bg-header flex items-center px-6">
      <div className="flex items-center justify-between w-full max-w-7xl mx-auto">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-12 h-12 rounded-full bg-white overflow-hidden ring-1 ring-header-foreground/20 group-hover:ring-header-foreground/40 transition-colors">
            <img
              src="/logo.jpeg"
